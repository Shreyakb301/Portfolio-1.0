                ...
                <div className="container mx-auto max-w-4xl pt-24 pb-6 lg:pt-32 lg:pb-10 px-4 md:px-6">
                    <div className="flex flex-col items-start gap-4 md:flex-row md:justify-between md:gap-8">
                        <div className="flex-1 space-y-4">
                            <h1 className="inline-block font-heading text-5xl tracking-tight lg:text-7xl font-bold">
                                About
                            </h1>
                    ...
                    <div className="grid gap-10 pb-8">
                        <div className="prose prose-xl dark:prose-invert max-w-none text-muted-foreground">
                            <p>
