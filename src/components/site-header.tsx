            ...
            <div className="container mx-auto flex h-16 items-center justify-between px-6 md:px-12">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-1">
                        <Button asChild variant="ghost" size="icon" className="h-10 w-10 text-muted-foreground hover:text-primary hover:bg-transparent transition-colors duration-200 cursor-none rounded-none">
